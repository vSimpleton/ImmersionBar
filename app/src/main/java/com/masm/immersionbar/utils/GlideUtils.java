...
public class GlideUtils {
    ...
    public static void load(Object object, ImageView imageView) {
        ...
        load(object, imageView, R.drawable.test);
    }
    ...
    public static void loadBlurry(ImageView imageView, Object o) {
        ...
        if (drawable == null) {
            drawable = ContextCompat.getDrawable(imageView.getContext(), R.drawable.test);
        }
        if (!Utils.isNetworkConnected(imageView.getContext())) {
            o = ContextCompat.getDrawable(imageView.getContext(), R.drawable.test);
        }
